...
public:
	...
	blaze::StaticVector<double, 3UL> getStraightLengthsOfTubes();
	...
	std::tuple<double, double, double, double, double, double> getMinMaxTubeTorsions();
...
private:
	...
	blaze::StaticVector<double, 4UL> m_h_0;			// initial orientation of local frame at s = 0 ==>> non-unity QUATERNION
