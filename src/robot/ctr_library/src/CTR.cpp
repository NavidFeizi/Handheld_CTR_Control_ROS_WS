...
blaze::StaticVector<double, 5UL> CTR::ODESolver(const blaze::StaticVector<double, 5UL> &initGuess)
{
	...
	constexpr double abs_tol = 1.00E-12;
	constexpr double rel_tol = 1.00E-10;

	// auto controlled_stepper = boost::numeric::odeint::make_controlled(abs_tol, rel_tol, abm8_stepper);
	auto controlled_stepper = boost::numeric::odeint::make_controlled(abs_tol, rel_tol, rk78_stepper);
