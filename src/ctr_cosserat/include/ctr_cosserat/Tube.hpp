...
private:
	...
	double m_G;
	double m_J;
	blaze::DiagonalMatrix<blaze::StaticMatrix<double, 3UL, 3UL, blaze::columnMajor>> m_K;
	double m_ls;
	double m_lc;
...
public:
	...
	// getter method for returning the outer radius of the tube
	double getTubeOuterRadius();
	...
	blaze::DiagonalMatrix<blaze::StaticMatrix<double, 3UL, 3UL, blaze::columnMajor>> getK_Matrix();
